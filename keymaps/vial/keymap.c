...
[0] = LAYOUT_65_ansi(
   ...
   RGB_TOG, KC_TAB,  KC_Q,    KC_W,    KC_E, KC_R, KC_T,   KC_Y, KC_U, KC_I,    KC_O,    KC_P,    KC_LBRC,  KC_RBRC,  KC_BSLS, KC_VOLU, 
   RGB_TOG, KC_CAPS, KC_A,    KC_S,    KC_D, KC_F, KC_G,   KC_H, KC_J, KC_K,    KC_L,    KC_SCLN, KC_QUOT,            KC_ENT,  KC_VOLD,
   RGB_VAI, KC_LSFT, KC_Z,    KC_X,    KC_C, KC_V, KC_B,   KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,            KC_UP,   KC_RCTL,
   RGB_VAD, KC_LCTL, KC_LGUI, KC_LALT,             KC_SPC,                      KC_RALT, MO(1),   KC_LEFT,            KC_DOWN, KC_RGHT
  ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [0] = { ENCODER_CCW_CW(RGB_HUD, RGB_HUI), ENCODER_CCW_CW(RGB_RMOD, RGB_MOD) },
