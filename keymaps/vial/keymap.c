...
[0] = LAYOUT_65_ansi(
   ...
   QK_BOOT, KC_LSFT, KC_Z,    KC_X,    KC_C, KC_V, KC_B,   KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,            KC_UP,   KC_RCTL,
     RESET, KC_LCTL, KC_LGUI, KC_LALT,             KC_SPC,                      KC_RALT, MO(1),   KC_LEFT,            KC_DOWN, KC_RGHT
  ),
